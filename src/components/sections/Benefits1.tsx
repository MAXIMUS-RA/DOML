...
function Benefits1() {
  ...
  return (
    <section className="max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-center px-2 xl:px-0 lg:gap-[135px] overflow-hidden h-auto ">
      <div className=" w full order-2 lg:order-1">
        ...
        <Button text={"Learn more"} black={false} />
      </div>
